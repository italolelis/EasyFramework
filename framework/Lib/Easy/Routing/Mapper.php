...
class Mapper {
    ...
    protected static function _validateRouteClass($routeClass) {
        if (!class_exists($routeClass) || !is_subclass_of($routeClass, 'Route')) {
            throw new RouterException(__('Route classes must extend Route'));
        }
        return $routeClass;
    }
