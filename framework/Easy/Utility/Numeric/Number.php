    ...
    public static function toReadableSize($size)
    {
        switch (true) {
            ...
            case round($size / 1024) < 1024:
                return __('%d KB', self::precision($size / 1024, 0));
            case round($size / 1024 / 1024, 2) < 1024:
                return __('%.2f MB', self::precision($size / 1024 / 1024, 2));
            case round($size / 1024 / 1024 / 1024, 2) < 1024:
                return __('%.2f GB', self::precision($size / 1024 / 1024 / 1024, 2));
            default:
                return __('%.2f TB', self::precision($size / 1024 / 1024 / 1024 / 1024, 2));
        }
    }
