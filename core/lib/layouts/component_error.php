...
<html>
    <head>
        ...
        <title>Componente não encontrado - EasyFramework</title>
    ...
    <body>
        ...
        <section id="error">
            ...
            <p>O arquivo <code>app/components/<?php echo Inflector::underscore($details['component']) ?>.php</code> não pode ser encontrado. Verifique se ele existe, e se possui sua classe <code><?php echo $details['component'] ?></code> correspondente.</p>
        </section>
