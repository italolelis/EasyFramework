...
<html>
    <head>
        ...
        <title>Controller não encontrado - EasyFramework</title>
    ...
    <body>
        ...
        <section id="error">
            ...
            <p>Não foi possível encontrar o controller  <strong><?= $details['controller'] . "Controller" ?></strong>. É possível que o arquivo <code>app/controllers/<?= $details['controller'] ?>_controller.php</code> não exista, ou que a classe <strong><?= $details['controller'] . "Controller" ?></strong> não esteja definida.</p>
        </section>
        <footer>
