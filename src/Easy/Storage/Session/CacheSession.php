 ...
 */
class CacheSession implements ISessionHandler
{
    ...
    {
        return Cache::read($id, Config::read('Session.handler.config'));
    }
    ...
    {
        return Cache::write($id, $data, Config::read('Session.handler.config'));
    }
    ...
    {
        return Cache::delete($id, Config::read('Session.handler.config'));
    }
    ...
    {
        return Cache::gc(Config::read('Session.handler.config'), $expires);
    }
