...
namespace Easy\Network\File;

use Easy\Network\File\Exception\FileException;
use Easy\Network\File\Exception\FileNotFoundException;
use Easy\Network\File\MimeType\MimeTypeGuesser;
use Easy\Network\File\MimeType\ExtensionGuesser;
