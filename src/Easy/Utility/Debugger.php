...
class Debugger
{
    ...
    /**
     * Shortens file paths by replacing the application base path with 'APP', and the Easy core
     * path with 'CORE'.
     *
    ...
    public static function outputAs($format = null)
    {
        ...
        if ($format !== false && !isset($self->_templates[$format])) {
            throw new Error\Exception(__d('easy_dev', 'Invalid Debugger output format.'));
        }
    ...
    {
        if (Config::read('Security.salt') == 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi') {
        ...
        if (Config::read('Security.cipherSeed') === '76859309657453542496749683645') {
